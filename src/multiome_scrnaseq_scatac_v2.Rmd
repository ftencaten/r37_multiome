...
ifn.genes.peaks = c("IFNG", "IFNA8", "IFNA6", "IFNA14", "IFNA16", "IFNB1", "IFNK", "IFNL1")

cvg.plot.ifn <- CoveragePlot(ln.obj, region = ifn.genes.peaks, ymax = 50, peaks = F, ncol = 2) 

ggsave('coverage_plot_interferon.pdf', cvg.plot.ifn, width = 6.5, height = 12)
